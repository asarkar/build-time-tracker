...
class ConsolePrinter(private val out: PrintStream = System.out) : Printer {
    override fun print(input: PrinterInput) {
        ...
        val scalingFraction = minOf(input.ext.maxWidth.toDouble(), maxDuration) / maxDuration
    ...
    companion object {
        ...
        private fun Double.percentOf(buildDuration: Double): Int = round(this / buildDuration * 100).toInt()
